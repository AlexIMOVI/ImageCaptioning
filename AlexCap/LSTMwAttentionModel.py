...
from AlexCap.AttentionLanguageModule import Decoder as LLM
...
class AlexCapModel(nn.Module):
    ...
    def forward_train(self, data):
        ...
        if self.eval_mode:
            with torch.no_grad():
                ...
                preds, alphas = self.llm.forward(features_ouput, gt_labels)
    ...
    def forward_test(self, data):
        ...
        with torch.no_grad():
            ...
            preds, alphas = self.llm.forward(features_ouput, empty)
