...
def get_config():
    ...
    cfg.save_path = "AlexGTModel/models/best_model_transformer_gt.pth"
    cfg.loss_file = 'AlexGTModel/logs/loss_history_transformer_gt.json'
    cfg.result_file = 'AlexGTModel/logs/results_history_transformer_gt.json'
