...
from AlexCap.LSTMModel import AlexCapModel
from AlexCap.AlexDataLoader import AlexDataLoader
from AlexCap.LSTM_opts import get_LSTM_config, name_LSTM_model
...
opt.loss_file, opt.result_file, opt.save_path = name_LSTM_model(opt)
